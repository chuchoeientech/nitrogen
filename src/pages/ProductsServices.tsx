                    ...
                    <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-3xl p-8 md:p-12 lg:p-16 border border-blue-100">
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                ...
                                <h2 className="text-4xl font-bold text-slate-900 mb-6">Urea 46% N</h2>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <h3 className="font-semibold text-slate-900">High Nitrogen Content</h3>
                                    ...
                                    <div className="flex items-start gap-3">
                                        <CheckCircle2 className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" />
                                        <div>
                                            <h3 className="font-semibold text-slate-900">Versatile Application</h3>
